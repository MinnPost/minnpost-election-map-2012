...
module.exports = function(grunt) {
    ...
    concat: {
      ...
      libs: {
        src: [
          ...
          'bower_components/mapbox.js/dist/mapbox.js'
        ],
      ...
      libs_css: {
        src: [
          'bower_components/mapbox.js/dist/mapbox.css'
        ], 
        dest: 'dist/<%= pkg.name %>.libs.css'
      },
      libs_css_ie: {
        src: [
          'bower_components/mapbox.js/dist/mapbox.ie.css'
        ],
  ...
  // Watch tasks
  grunt.registerTask('lint-watch', ['jshint']);
